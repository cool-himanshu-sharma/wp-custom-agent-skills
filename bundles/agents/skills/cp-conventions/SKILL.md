...
compatibility: "WordPress 6.5+ / PHP 7.4+. Content is derived per-organisation by cp-conventions-bootstrap."
---
...
**To populate it:** run `/cp-bootstrap-conventions` with paths to two or more real plugin
...
Populated by `cp-conventions-bootstrap`. Expected files:
