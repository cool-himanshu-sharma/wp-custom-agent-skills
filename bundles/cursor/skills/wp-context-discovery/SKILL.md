...
```bash
node .cursor/skills/wp-context-discovery/scripts/plugin_context.mjs <plugin-root>
node .cursor/skills/wp-context-discovery/scripts/plugin_context.mjs <plugin-root> --json
```
