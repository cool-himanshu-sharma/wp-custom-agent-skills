# wp-custom-agent-skills — Cursor bundle
...
Copy the **contents of this folder** into `<your-plugin>/.cursor/` in your WordPress plugin repo:
...
skills/ (disable-model-invocation)  ->  type /wp-spec in chat

## The official WordPress skills (optional but recommended)

This bundle contains the Cursor workflow layer only. The official WordPress
...
cp -r agent-skills/skills/* <your-plugin>/.cursor/skills/
```
...
```
.cursor/skills/wp-context-discovery/scripts/plugin_context.mjs
```
