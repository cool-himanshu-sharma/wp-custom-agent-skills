...
```bash
node .agent/skills/cp-context-discovery/scripts/plugin_context.mjs <plugin-root>
node .agent/skills/cp-context-discovery/scripts/plugin_context.mjs <plugin-root> --json
```
