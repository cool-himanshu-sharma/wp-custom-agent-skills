...
```bash
node .agent/skills/wp-context-discovery/scripts/plugin_context.mjs <plugin-root>
node .agent/skills/wp-context-discovery/scripts/plugin_context.mjs <plugin-root> --json
```
