...
The full standard is enforced by PHPCS (`wp-static-analysis`). This page covers what the
...
Covered in depth in `skills/wp-security-review/references/checklist.md`. The rules that
