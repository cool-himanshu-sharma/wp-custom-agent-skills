...
```bash
node .codex/skills/cp-context-discovery/scripts/plugin_context.mjs <plugin-root>
node .codex/skills/cp-context-discovery/scripts/plugin_context.mjs <plugin-root> --json
```
