...
```bash
node .cursor/skills/cp-context-discovery/scripts/plugin_context.mjs <plugin-root>
node .cursor/skills/cp-context-discovery/scripts/plugin_context.mjs <plugin-root> --json
```
